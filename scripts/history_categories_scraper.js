...
var stream = fs.createWriteStream('history_films.csv');
var streamSubCat = fs.createWriteStream('history_subcat.csv');
var streamPageViews = fs.createWriteStream('history_page_views.csv');
let countries = [];
...
var lineReader = require('readline').createInterface({
    input:fs.createReadStream('subcats/history_cats.txt')
})
...
for (var i = 0; i < countries.length; i++) {
    ...
    let country = countries[i].substring(20);
    //console.log(country);
